...
public class GameImageSelectorScreenPS1 extends javax.swing.JDialog {
    ...
    public GameImageSelectorScreenPS1(java.awt.Frame parent, boolean modal, ImageSelectListener imageSelectListener, ImageChangedListener imageChangedListener, int currentImageNumber, String imageType, File image, int numberOfFiles, String gameID, int currentListIndex) {
        super(parent, modal);
            ...
            public void windowClosing(WindowEvent ev) {
               ...
               if (!imageSaved){
                   ...
                   switch (imageType) {
                       case "_COV":
                       case "_COV2":
                           imageSelectListener.imageSelected(imageType, new File(NO_IMAGE_PS1_COVER_PATH));
                           break;
                       case "_SCR":
                       case "_SCR2":
    ...
    private void initialiseGUI(){
        ...
        switch (imageType) {
            case "_COV":
                ...
                jLabelGameImage.setIcon(new ImageIcon(new ImageIcon(image.toString()).getImage().getScaledInstance(160, 160, Image.SCALE_DEFAULT)));
                break;
            case "_COV2":
            ...
            case "_BG":
                ...
                jLabelGameImage.setIcon(new ImageIcon(new ImageIcon(image.toString()).getImage().getScaledInstance(jLabelGameImage.getWidth(), jLabelGameImage.getHeight(), Image.SCALE_DEFAULT)));
                break;
            case "_SCR":
    ...
    private void initComponents() {
        ...
        jPanelGameBackgroundImageLayout.setVerticalGroup(
            ...
            .addGroup(jPanelGameBackgroundImageLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelGameImage, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)

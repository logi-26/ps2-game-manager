            ...
            if (gameSizeValue > 5000000){
                ...
                switch (fileType) {
                    case "CONFIG":
                        ...
                        break;
                    case "_SCR2":
                        apiClient.getImageFromServer(selectedGame, PopsGameManager.determineGameRegion(splitName[0]), gameID, gameName, fileType, fileType, 1, true);
                        break;
                    default:
                        apiClient.getImageFromServer(selectedGame, PopsGameManager.determineGameRegion(splitName[0]), gameID, gameName, fileType, fileType, 0, true);
                        break;
                }

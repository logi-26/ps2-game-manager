...
public class GameImageScreenPS2 extends javax.swing.JDialog implements ImageSelectListener, ImageChangedListener{
    ...
    public void getNextImageFromServer(String coverType, int currentImageNumber){
        ...
        File image; 
        if (coverType.equals("_ICO")) {image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverType + ".png");}
        else {image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverType + ".jpg");}
    ...
    public void getImageFromServer(String coverType, String coverPath, int currentImageNumber){
        ...
        if (numberOfFiles > 0){
            ...
            File image; 
            if (coverType.equals("_ICO")) {image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverPath + ".png");}
            else {image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverPath + ".jpg");}
    ...
    private void displayGameImages(){
        ...
        // Front cover
        File frontCover = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_COV" + ".jpg");
        if(frontCover.exists() && !frontCover.isDirectory()) {jLabelGameFrontCover.setIcon(new ImageIcon(new ImageIcon(frontCover.toString()).getImage().getScaledInstance(jLabelGameFrontCover.getWidth(), jLabelGameFrontCover.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            frontCover = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_COV" + ".png");
            if(frontCover.exists() && !frontCover.isDirectory()) {jLabelGameFrontCover.setIcon(new ImageIcon(new ImageIcon(frontCover.toString()).getImage().getScaledInstance(jLabelGameFrontCover.getWidth(), jLabelGameFrontCover.getHeight(), Image.SCALE_DEFAULT)));}
        ...
        // Rear cover
        File rearCover = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_COV2" + ".jpg");
        if(rearCover.exists() && !rearCover.isDirectory()) {jLabelGameRearCover.setIcon(new ImageIcon(new ImageIcon(rearCover.toString()).getImage().getScaledInstance(jLabelGameRearCover.getWidth(), jLabelGameRearCover.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            rearCover = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_COV2" + ".png");
            if(rearCover.exists() && !rearCover.isDirectory()) {jLabelGameRearCover.setIcon(new ImageIcon(new ImageIcon(rearCover.toString()).getImage().getScaledInstance(jLabelGameRearCover.getWidth(), jLabelGameRearCover.getHeight(), Image.SCALE_DEFAULT)));}
        ...
        // Background image
        File backgroundImage = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_BG" + ".jpg");
        if(backgroundImage.exists() && !backgroundImage.isDirectory()) {jLabelGameBackgroundImage.setIcon(new ImageIcon(new ImageIcon(backgroundImage.toString()).getImage().getScaledInstance(jLabelGameBackgroundImage.getWidth(), jLabelGameBackgroundImage.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            backgroundImage = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_BG" + ".png");
            if(backgroundImage.exists() && !backgroundImage.isDirectory()) {jLabelGameBackgroundImage.setIcon(new ImageIcon(new ImageIcon(backgroundImage.toString()).getImage().getScaledInstance(jLabelGameBackgroundImage.getWidth(), jLabelGameBackgroundImage.getHeight(), Image.SCALE_DEFAULT)));}
        ...
        // Disc image
        File discImage = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_ICO" + ".jpg");
        if(discImage.exists() && !discImage.isDirectory()) {jLabelGameDiscImage.setIcon(new ImageIcon(new ImageIcon(discImage.toString()).getImage().getScaledInstance(jLabelGameDiscImage.getWidth(), jLabelGameDiscImage.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            discImage = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_ICO" + ".png");
            if(discImage.exists() && !discImage.isDirectory()) {jLabelGameDiscImage.setIcon(new ImageIcon(new ImageIcon(discImage.toString()).getImage().getScaledInstance(jLabelGameDiscImage.getWidth(), jLabelGameDiscImage.getHeight(), Image.SCALE_DEFAULT)));}
        ...
        // Screenshot 1 image
        File screenshot1Image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_SCR" + ".jpg");
        if(screenshot1Image.exists() && !screenshot1Image.isDirectory()) {jLabelGameScreenshot1.setIcon(new ImageIcon(new ImageIcon(screenshot1Image.toString()).getImage().getScaledInstance(jLabelGameScreenshot1.getWidth(), jLabelGameScreenshot1.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            screenshot1Image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_SCR" + ".png");
            if(screenshot1Image.exists() && !screenshot1Image.isDirectory()) {jLabelGameScreenshot1.setIcon(new ImageIcon(new ImageIcon(screenshot1Image.toString()).getImage().getScaledInstance(jLabelGameScreenshot1.getWidth(), jLabelGameScreenshot1.getHeight(), Image.SCALE_DEFAULT)));}
        ...
        // Screenshot 2 image
        File screenshot2Image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_SCR2" + ".jpg");
        if(screenshot2Image.exists() && !screenshot2Image.isDirectory()) {jLabelGameScreenshot2.setIcon(new ImageIcon(new ImageIcon(screenshot2Image.toString()).getImage().getScaledInstance(jLabelGameScreenshot2.getWidth(), jLabelGameScreenshot2.getHeight(), Image.SCALE_DEFAULT)));}
            ...
            screenshot2Image = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + "_SCR2" + ".png");
            if(screenshot2Image.exists() && !screenshot2Image.isDirectory()) {jLabelGameScreenshot2.setIcon(new ImageIcon(new ImageIcon(screenshot2Image.toString()).getImage().getScaledInstance(jLabelGameScreenshot2.getWidth(), jLabelGameScreenshot2.getHeight(), Image.SCALE_DEFAULT)));}
    ...
    private void deleteImage(String coverType){
        ...
        File imageFile = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverType + ".jpg");
        if(imageFile.exists() && !imageFile.isDirectory()) {imageFile.delete();}
        
        // Delete the file if it is a png
        imageFile = new File(PopsGameManager.getOPLFolder() + File.separator + "ART" + File.separator + gameList.get(currentListIndex).getGameID() + coverType + ".png");
        if(imageFile.exists() && !imageFile.isDirectory()) {imageFile.delete();}

...
/**
 * Paths, relative to getCurrentDirectory(), that an app update must never touch
 * user data and runtime state, not app code.
 */
public final class UpdatePreserveList {
    ...
    // True if relativeToCurrentDir (or anything under it) must never be overwritten/deleted by an update

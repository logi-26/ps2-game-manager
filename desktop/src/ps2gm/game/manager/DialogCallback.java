 ...
 * confirmation, without depending on a UI toolkit (JavaFX or Swing) directly.
 */
public interface DialogCallback {
    ...
    // Shows an info message for a few seconds, then auto-closes. Blocks the caller until it closes.

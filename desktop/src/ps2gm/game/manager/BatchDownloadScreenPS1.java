...
public class BatchDownloadScreenPS1 extends javax.swing.JDialog {
    ...
    private void downloadMissingFiles(){
        ...
        if (apiClient.sendMessageToServer("RESPOND").equals("RESPONSE")){
            ...
            if (jCheckBoxFrontCover.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_COV")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_COV").execute();}
            if (jCheckBoxRearCover.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_COV2")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_COV2").execute();}
            if (jCheckBoxDiscImage.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_ICO")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_ICO").execute();}
            if (jCheckBoxScreenshot.isSelected()) {
                for (int i = 0; i < gameList.size(); i++) {if (GameArtFileManager.isMissing(artList, gameList.get(i), "_SCR")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_SCR").execute();}
                for (int i = 0; i < gameList.size(); i++) {if (GameArtFileManager.isMissing(artList, gameList.get(i), "_SCR2")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_SCR2").execute();}
            }
            if (jCheckBoxBackground.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_BG")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_BG").execute();}
            if (jCheckBoxSpine.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_LAB")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_LAB").execute();}
            if (jCheckBoxLogo.isSelected()) {for (int i = 0; i < gameList.size(); i++) if (GameArtFileManager.isMissing(artList, gameList.get(i), "_LGO")) new BackgroundWorker(gameList.get(i).getGameName(), gameList.get(i).getGameID(), "_LGO").execute();}
    ...
    private void initComponents() {
        ...
        jPanelGameFrontCover.setPreferredSize(new java.awt.Dimension(192, 200));
        ...
        jPanelGameRearCover.setPreferredSize(new java.awt.Dimension(192, 200));

...
public class GameImageScreenPS1 extends javax.swing.JDialog implements ImageSelectListener, ImageChangedListener {
    ...
    private static final java.awt.Dimension COVER_PREVIEW   = new java.awt.Dimension(160, 160);
    ...
    private void displayGameImages(){
        ...
        jLabelGameFrontCover.setIcon(scaledIcon(frontCover != null ? frontCover.toString() : NO_IMAGE_PS1_COVER_PATH, COVER_PREVIEW));

        // Rear cover
        File rearCover = GameArtFileManager.resolve(game, "_COV2");
        jLabelGameRearCover.setIcon(scaledIcon(rearCover != null ? rearCover.toString() : NO_IMAGE_PS1_COVER_PATH, COVER_PREVIEW));
    ...
    // leaves one axis as DEFAULT_SIZE (spine, logo). displayGameImages() rescales each icon
    // to jLabel.getWidth()/getHeight(); without a fixed preferred size the label's preferred
    // size tracks the icon, so every arrow-button refresh feeds the label's own (border-inflated)
    // size back in and the form creeps taller on each click. Set here, outside initComponents(),
    // so a future NetBeans form save can't silently drop it.
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jPanelGameFrontCover, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                        .addComponent(jPanelGameRearCover, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)

        ...
        if (!gameListPS2.isEmpty()){
            ...
            gameListPS2.forEach((game) -> {
                ...
                try {
                    ...
                    InputStream in = GameListManager.class.getResourceAsStream("/ps2gm/game/manager/PS2SpineTemplate.png"); 
        ...
        if (!gameListPS1.isEmpty()){
            ...
            gameListPS1.forEach((game) -> {
                ...
                if (gameName.length() <= 32){
                    ...
                    // Generate the spine ART
                    try {
                        InputStream in = GameListManager.class.getResourceAsStream("/ps2gm/game/manager/PS1SpineTemplate.png"); 
                        BufferedImage bufferedImage = ImageIO.read(in);
                        Graphics2D graphics = bufferedImage.createGraphics();

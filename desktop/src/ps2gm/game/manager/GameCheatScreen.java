...
public class GameCheatScreen extends javax.swing.JDialog {
    ...
    private void getServerCheatList(){
        ...
        apiClient.getListFromServer("CHEAT", PopsGameManager.getCurrentConsole());
    ...
    private void getCheatsFromServer(){
        ...
        if (!serverCheatList.isEmpty() && serverCheatList.contains(gameList.get(currentListIndex).getGameID())){
            ...
            String cheat = apiClient.getCheatFromServer(PopsGameManager.determineGameRegion(splitName[0]), gameList.get(currentListIndex).getGameID());
            ...
            if (cheat != null && !cheat.equals("NO_CHEAT")) {
                ...
                if (PopsGameManager.getCurrentConsole().equals("PS1")){
                    ...
                    InputStream in = GameListManager.class.getResourceAsStream("/ps2gm/game/manager/WidescreenListPS1.txt"); 
                ...
                if (PopsGameManager.getCurrentConsole().equals("PS2")){
                    InputStream in = GameListManager.class.getResourceAsStream("/ps2gm/game/manager/WidescreenListPS2.txt"); 
                    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(in));
                    String line;
                    try {
                        while ((line = bufferedReader.readLine()) != null) {
